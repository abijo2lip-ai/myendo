// Flointra — Doctor Export: PDF Generation
...
<head>
  ...
  <title>Flointra Health Report</title>
  <style>${css}</style>
</head>
<body>
  ...
  <!-- ═══════════════════════════════════════════════════════ HEADER -->
  <div class="header">
    <h1>Flointra Health Report</h1>
    <div class="subtitle">
      ${formatDate(dateRange.from)} — ${formatDate(dateRange.to)}
      &nbsp;·&nbsp; Generated ${formatDate(generatedDate)}
    </div>
    <div class="disclaimer">
      ⚕️ This report is generated from your personal tracking data in Flointra.
  ...
  <!-- ═══════════════════════════════════════════════════════ FOOTER -->
  <div class="footer">
    Generated by Flointra — This is not a medical diagnosis. Discuss with your doctor.
  </div>
